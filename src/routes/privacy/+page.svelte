...
>
  <div class="m-20">
    ...
    <div transition:fade={{duration: 1000, easing: sineIn}}>
      <p>
      ...
      <p>
        ...
        purposes, we use a self-hosted instance @ analytics.uvvu.pw. This website does not track you in any way across websites
